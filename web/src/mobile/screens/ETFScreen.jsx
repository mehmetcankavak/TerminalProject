    ...
    <div style={{ padding: '12px 16px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 6 }}>
        ...
        <div style={{
          ...
          <div style={{ fontSize: 9, fontWeight: 800, color: '#aaa', letterSpacing: 0.5 }}>BREADTH</div>
          <div style={{ fontSize: 13, fontWeight: 800, fontFamily: 'var(--mono)', color: '#fff', marginTop: 3 }}>
            <span style={{ color: '#00d992' }}>↑{gainers}</span>
            <span style={{ color: '#666' }}> · </span>
            <span style={{ color: '#f43f5e' }}>↓{losers}</span>
          </div>
          <div style={{ fontSize: 9, color: '#888', fontFamily: 'var(--mono)', marginTop: 1 }}>yükselen / düşen</div>
        </div>
      </div>
    </div>
  )
